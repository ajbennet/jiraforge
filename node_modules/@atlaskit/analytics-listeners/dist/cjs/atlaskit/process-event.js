...
var _extractDataFromEvent = require("./extract-data-from-event");
...
var _default = exports.default = function _default(event, logger) {
  ...
  var attributes = _objectSpread(_objectSpread({
    ...
    packageHierarchy: (0, _extractDataFromEvent.getPackageHierarchy)(event) || undefined
  }, {
  ...
  if (event.payload) {
    if (eventType === _analyticsGasTypes.UI_EVENT_TYPE) {
      return {
        eventType: eventType,
        source: source,
        actionSubject: (0, _extractDataFromEvent.getActionSubject)(event),
        action: action,
    ...
    if (eventType === _analyticsGasTypes.TRACK_EVENT_TYPE || eventType === _analyticsGasTypes.OPERATIONAL_EVENT_TYPE || eventType === _analyticsGasTypes.SCREEN_EVENT_TYPE) {
