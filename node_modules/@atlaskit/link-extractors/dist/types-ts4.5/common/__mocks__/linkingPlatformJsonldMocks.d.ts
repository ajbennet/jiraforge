...
export declare const TEST_INTERACTIVE_HREF_URL = "https://my.url.com/embed";
export declare const TEST_NAME = "my name";
export declare const TEST_NAME_WITH_HIGHLIGHTING = "my name | :~:text=highlight this";
export declare const TEST_STRING = "foo";
export declare const TEST_ARI = "ari:cloud:confluence:DUMMY-12345678-abcd-efgh-adbb-a0906ccc722b:page/1228472772";
export declare const TEST_LINK: JsonLd.Primitives.Link;
export declare const TEST_INTERACTIVE_HREF_LINK: {
    '@type': string;
    href: string;
...
export declare const TEST_OBJECT_WITH_HIGHLIGHTING: JsonLd.Primitives.Object;
...
export declare const TEST_BASE_DATA_WITH_HIGHLIGHTING: JsonLd.Data.BaseData;
