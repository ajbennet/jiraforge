...
const RemovableTagComponent = /*#__PURE__*/forwardRef(({
  ...
  const hoverCloseButtonColors = {
    ...
    [cssVar.color.background.hover]: fg('platform-component-visual-refresh') ? undefined : removalHoverBackgroundColors,
    // Tag background color on press
    [cssVar.color.background.active]: fg('platform-component-visual-refresh') ? undefined : removalActiveBackgroundColors,
    // The tag text on hover of remove button
    [cssVar.color.text.default]: fg('platform-component-visual-refresh') ? undefined : removalTextColors,
    // 'elemBefore' text on press of remove button
    [cssVar.color.text.active]: fg('platform-component-visual-refresh') ? undefined : removalTextColors,
    // The tag link text on hover of remove button
    [cssVar.color.text.link]: fg('platform-component-visual-refresh') ? undefined : removalTextColors
  };
