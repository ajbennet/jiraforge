...
var RemovableTagComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  }, cssVar.color.background.hover, fg('platform-component-visual-refresh') ? undefined : removalHoverBackgroundColors), cssVar.color.background.active, fg('platform-component-visual-refresh') ? undefined : removalActiveBackgroundColors), cssVar.color.text.default, fg('platform-component-visual-refresh') ? undefined : removalTextColors), cssVar.color.text.active, fg('platform-component-visual-refresh') ? undefined : removalTextColors), cssVar.color.text.link, fg('platform-component-visual-refresh') ? undefined : removalTextColors);
