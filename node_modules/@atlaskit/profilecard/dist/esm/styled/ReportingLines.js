...
var ReportingLinesSectionLegacy = styled.div({
...
var ManagerSectionLegacy = styled.div({
  display: 'flex',
  alignItems: 'center',
  margin: "var(--ds-space-050, 4px)".concat(" ", "var(--ds-space-050, 4px)")
});
export var ManagerSection = function ManagerSection(_ref2) {
