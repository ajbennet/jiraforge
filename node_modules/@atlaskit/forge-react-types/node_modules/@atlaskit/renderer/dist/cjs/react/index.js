...
var ReactSerializer = exports.default = /*#__PURE__*/function () {
  function ReactSerializer(init) {
    var _this = this;
    (0, _classCallCheck2.default)(this, ReactSerializer);
    ...
    (0, _defineProperty2.default)(this, "serializeFragmentChild", function (node, _ref) {
      ...
      var marks = node.marks ? (0, _toConsumableArray2.default)(node.marks) : [];
    ...
    (0, _defineProperty2.default)(this, "getAnnotationMarkProps", function (mark, marksParentPath) {
      var annotationParentIds = (marksParentPath || []).reduce(function (acc, parent) {
        if ((0, _marks.isAnnotationMark)(parent)) {
          return [].concat((0, _toConsumableArray2.default)(acc), [parent.attrs.id]);
        }
        return acc;
      }, []);
      return {
    ...
    (0, _defineProperty2.default)(this, "getMarkProps", function (mark, marksParentPath, node) {
      if ((0, _marks.isAnnotationMark)(mark)) {
        return _this.getAnnotationMarkProps(mark, marksParentPath);
      }
      var _mark$attrs = mark.attrs,
        key = _mark$attrs.key,
        otherAttrs = (0, _objectWithoutProperties2.default)(_mark$attrs, _excluded);
      var extraProps = {
  ...
  return (0, _createClass2.default)(ReactSerializer, [{
    ...
    value: function serializeFragment(fragment) {
      ...
      var target = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.allowSelectAllTrap ? _nodes.DocWithSelectAllTrap : _nodes.Doc;
      ...
      if (!(0, _nodes.isTextNode)(mark)) {
        var serializeContent = function serializeContent(childMark, index) {
          return _this4.serializeMark({
            ...
            parentMark: {
              path: [].concat((0, _toConsumableArray2.default)(parentMark.path), [childMark])
            }
          });
        };
    ...
    value: function headingAnchorSupported() {
      ...
      return (0, _links.isNestedHeaderLinksEnabled)(this.allowHeadingAnchorLinks) || path.length === 0 || isImmediateParent(path, 'layoutColumn');
    }
  }, {
    key: "getHeadingProps",
    ...
    value: function getChildNodes(fragment) {
      ...
      return (0, _nodes.mergeTextNodes)(children);
    }
  }, {
    key: "getMarks",
    value: function getMarks(node) {
      ...
      return (0, _validator.getMarksByOrder)(node.marks);
    }
  }, {
