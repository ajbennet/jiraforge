export let PLATFORMS = /*#__PURE__*/function (PLATFORMS) {
...
export let FULL_WIDTH_MODE = /*#__PURE__*/function (FULL_WIDTH_MODE) {
  FULL_WIDTH_MODE["FIXED_WIDTH"] = "fixedWidth";
  FULL_WIDTH_MODE["FULL_WIDTH"] = "fullWidth";
  return FULL_WIDTH_MODE;
}({});
export let BROWSER_FREEZE_INTERACTION_TYPE = /*#__PURE__*/function (BROWSER_FREEZE_INTERACTION_TYPE) {
