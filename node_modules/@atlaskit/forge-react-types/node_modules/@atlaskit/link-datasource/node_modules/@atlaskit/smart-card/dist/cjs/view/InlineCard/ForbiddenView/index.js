...
var InlineCardForbiddenViewNew = function InlineCardForbiddenViewNew(_ref) {
  var url = _ref.url,
    icon = _ref.icon,
...
var InlineCardForbiddenView = exports.InlineCardForbiddenView = function InlineCardForbiddenView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/_react.default.createElement(InlineCardForbiddenViewNew, props);
  }
  return /*#__PURE__*/_react.default.createElement(_InlineCardForbiddenViewOld.InlineCardForbiddenViewOld, props);
};