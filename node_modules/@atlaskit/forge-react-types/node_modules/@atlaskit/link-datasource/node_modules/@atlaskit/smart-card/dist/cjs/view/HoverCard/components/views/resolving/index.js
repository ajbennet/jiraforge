...
var _HoverCardLoadingViewOld = _interopRequireDefault(require("./HoverCardLoadingViewOld"));
var loadingViewContainer = null;
var skeletonContainer = null;
var titleStyle = null;
var titleBlockStyles = null;
var HoverCardLoadingViewNew = function HoverCardLoadingViewNew(_ref) {
...
var HoverCardLoadingView = function HoverCardLoadingView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/_react.default.createElement(HoverCardLoadingViewNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_HoverCardLoadingViewOld.default, props);
  }
};
