...
var _AvatarGroupOld = _interopRequireDefault(require("./AvatarGroupOld"));
 ...
 */
var AvatarGroupNew = function AvatarGroupNew(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", (0, _extends2.default)({}, (0, _platformFeatureFlags.fg)('platform-linking-visual-refresh-v1') ? {} : (0, _defineProperty2.default)({}, 'data-fit-to-content', true), {
    ...
    ,
    className: (0, _runtime.ax)([stylesMap[size], (0, _platformFeatureFlags.fg)('platform-linking-visual-refresh-v1') && "_1ul91ns9", className])
...
var AvatarGroup = function AvatarGroup(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(AvatarGroupNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_AvatarGroupOld.default, props);
  }
};
