...
var _MediaOld = _interopRequireDefault(require("./MediaOld"));
 ...
 * @see Preview
 */
var MediaNew = function MediaNew(_ref) {
  var name = _ref.name,
...
var Media = function Media(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(MediaNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_MediaOld.default, props);
  }
};
