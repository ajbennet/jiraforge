...
exports.useFormattedWarningMessage = exports.WarningMessages = void 0;
...
var useFormattedWarningMessage = exports.useFormattedWarningMessage = function useFormattedWarningMessage() {
  var _useHydratedDeprecati = (0, _state.useHydratedDeprecations)(),
    _useHydratedDeprecati2 = (0, _slicedToArray2.default)(_useHydratedDeprecati, 1),
  ...
  var hasWarnings = (0, _useEditorViewHasWarnings.useEditorViewHasWarnings)();
  ...
  var formatWarnings = (0, _react.useCallback)(function (message) {
    var combinedMessages = [{
      type: 'warning',
      message: message
    }].concat((0, _toConsumableArray2.default)(externalWarnings));
  ...
  if (!hasWarnings) {
    ...
    return formatWarnings(formatMessage(_messages.messages.defaultWarning, {
...
var WarningMessages = exports.WarningMessages = function WarningMessages() {
