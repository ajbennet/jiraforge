...
var _ErrorSvgOld = require("./ErrorSvgOld");
...
var ErrorSVG = exports.ErrorSVG = function ErrorSVG(props) {
  if (!(0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(ErrorSVGNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_ErrorSvgOld.ErrorSVGOld, props);
  }
};