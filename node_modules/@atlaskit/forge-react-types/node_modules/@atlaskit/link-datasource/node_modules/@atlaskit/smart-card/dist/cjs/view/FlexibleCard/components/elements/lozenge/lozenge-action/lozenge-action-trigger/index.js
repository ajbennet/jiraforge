...
var _LozengeActionTriggerOld = _interopRequireDefault(require("./LozengeActionTriggerOld"));
...
var LozengeActionTriggerNew = function LozengeActionTriggerNew(_ref) {
...
var LozengeActionTrigger = function LozengeActionTrigger(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(LozengeActionTriggerNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_LozengeActionTriggerOld.default, props);
  }
};
