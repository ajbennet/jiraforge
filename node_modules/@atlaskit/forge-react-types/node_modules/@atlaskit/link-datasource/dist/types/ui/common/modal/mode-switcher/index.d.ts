...
export declare const ModeSwitcher: <T extends string = string>(props: ModeSwitcherProps<T>) => JSX.Element;
export declare const DatasourceViewModeDropDown: () => JSX.Element | null;
