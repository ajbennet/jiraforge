...
export declare const JiraSearchContainerNew: (props: SearchContainerProps) => JSX.Element;
export declare const JiraSearchContainer: (props: SearchContainerProps) => JSX.Element;
