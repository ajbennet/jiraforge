...
const DatasourceTableViewNew = withAnalyticsContext(componentMetadata.tableView)(props => /*#__PURE__*/React.createElement(StoreContainer, null, /*#__PURE__*/React.createElement(DatasourceExperienceIdProvider, null, /*#__PURE__*/React.createElement(DatasourceTableViewWithoutAnalytics, props))));
export const DatasourceTableView = props => {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(DatasourceTableViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(DatasourceTableViewOld, props);
  }
};