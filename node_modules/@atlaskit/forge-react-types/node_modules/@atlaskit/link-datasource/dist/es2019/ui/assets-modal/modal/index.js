...
const VERSION_TWO = '2';
const modalBodyErrorWrapperStyles = null;
...
export const AssetsConfigModalNew = withAnalyticsContext(contextData)(props => /*#__PURE__*/React.createElement(StoreContainer, null, /*#__PURE__*/React.createElement(DatasourceExperienceIdProvider, null, /*#__PURE__*/React.createElement(UserInteractionsProvider, null, /*#__PURE__*/React.createElement(PlainAssetsConfigModal, props)))));
export const AssetsConfigModal = props => {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(AssetsConfigModalNew, props);
  } else {
    return /*#__PURE__*/React.createElement(AssetsConfigModalOld, props);
  }
};