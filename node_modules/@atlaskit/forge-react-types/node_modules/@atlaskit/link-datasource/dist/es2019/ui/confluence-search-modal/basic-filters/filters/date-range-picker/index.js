...
export const DateRangePicker = ({
  ...
  const popupContent = () => {
    ...
    return /*#__PURE__*/React.createElement(CustomDropdownOld, null, dateRangeValues.map(option => /*#__PURE__*/React.createElement(CustomDropdownItemOld, {
      key: option
      // want to show Anytime as selected if none of the other options are selected
      ,
      isSelected: selectedValue ? option === selectedValue : option === defaultOptionValue,
      onClick: () => handleClickFilterOption(option)
    }, getDropdownLabel(option, formatMessage))), isPickerOpen && isCustomSelected && /*#__PURE__*/React.createElement(CustomDateWrapperOld, null, /*#__PURE__*/React.createElement(DatePickersWrapperOld, null, /*#__PURE__*/React.createElement(DatePicker, {
      maxDate: todayDate,
      innerProps: {
        style: {
          width: 140
    ...
    })), invalidDateRange && /*#__PURE__*/React.createElement(DateRangeErrorMessageOld, null, /*#__PURE__*/React.createElement(ErrorIcon, {
      LEGACY_size: "small",
      color: `var(--ds-icon-danger, ${R400})`,
      label: "Date range error",
      LEGACY_margin: `0 ${"var(--ds-space-negative-025, -2px)"}`
    }), invalidDateRange), /*#__PURE__*/React.createElement(SelectDateRangeButtonOld, {
      "data-testId": "custom-date-range-update-button",
      disabled: Boolean(invalidDateRange),
      onClick: handleClickUpdateDateRange
    }, formatMessage(dateRangeMessages.dateRangeUpdateButton))));
