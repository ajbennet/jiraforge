...
var _draggableTableHeadingOld = require("./draggable-table-heading-old");
...
var DraggableTableHeadingNew = function DraggableTableHeadingNew(_ref3) {
...
var DraggableTableHeading = exports.DraggableTableHeading = function DraggableTableHeading(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(DraggableTableHeadingNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_draggableTableHeadingOld.DraggableTableHeadingOld, props);
  }
};