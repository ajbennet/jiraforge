...
exports.getOrderedColumns = exports.IssueLikeDataTableView = exports.EmptyState = void 0;
...
var _issueLikeTableOld = require("./issue-like-table-old");
...
var ColumnPickerHeader = (0, _react.forwardRef)(function (_ref, __cmplr) {
  ...
  return /*#__PURE__*/React.createElement(C, (0, _extends2.default)({}, __cmplp, {
    style: __cmpls,
    ref: __cmplr,
    className: (0, _runtime.ax)(["_1bqmidpf _2eacidpf _1rmlidpf _13xs13hi _19xw13hi _ex0g13hi _1rag1on0 _1ul51on0 _12ch1on0 _12ruusvi _1pmsusvi _7okwusvi _mgulys9h _2k51ys9h _efqoys9h _1xzrzo7u _1ejpzo7u _1fmczo7u _77i31if8 _zjk41if8 _7s0n1if8 _3t471vc6 _9g2k1vc6 _1h0z1vc6 _1o59pxbi _1l3vpxbi _gdprpxbi _ml92nkob _1nfwnkob _11ljnkob _1ixkusic _s1peusic _mowjusic", __cmplp.className])
  }));
});
...
var Table = (0, _react.forwardRef)(function (_ref2, __cmplr) {
  ...
  return /*#__PURE__*/React.createElement(C, (0, _extends2.default)({}, __cmplp, {
    style: __cmpls,
    ref: __cmplr,
    className: (0, _runtime.ax)(["_1bsb1osq", __cmplp.className])
  }));
});
...
var keyBasedWidthMap = {
  ...
  // 100px
  status: _utils.COLUMN_BASE_WIDTH * 12.5,
...
var IssueLikeDataTableViewNew = function IssueLikeDataTableViewNew(_ref5) {
    ...
    return (0, _combine.combine)((0, _adapter.monitorForElements)({
      ...
      onDrop: function onDrop(_ref11) {
        ...
        if (source.data.type === 'table-header' && source.data.tableId === tableId) {
          ...
          onVisibleColumnKeysChange === null || onVisibleColumnKeysChange === void 0 || onVisibleColumnKeysChange((0, _toConsumableArray2.default)(newColumnKeyOrder));
  ...
  var view = /*#__PURE__*/React.createElement("div", {
    ...
    className: (0, _runtime.ax)(["_mrkbidpf _1o0zidpf _kqswh2mm", scrollableContainerHeight && "_1reo1wug _18m91wug _vchhusvi _bfhkchd4 _1itk10xm _ouxlbac2 _12vemgnk _1lrw1sd4 _qmxj1c00"]),
    ...
    className: (0, _runtime.ax)(["_19pkidpf _2hwxidpf _otyridpf _18u0idpf _yq5hus1c _btyzidpf"])
    ...
    if (isEditable) {
      ...
      var dragPreview = /*#__PURE__*/React.createElement(_dragColumnPreview.DragColumnPreview, {
        title: heading,
        rows: previewRows
      });
      return /*#__PURE__*/React.createElement(_draggableTableHeading.DraggableTableHeading, {
        tableId: tableId,
        key: key,
        id: key,
        index: cellIndex,
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      return /*#__PURE__*/React.createElement(InlineEditableTableCell, {
        ...
        className: (0, _runtime.ax)([!(wrappedColumnKeys !== null && wrappedColumnKeys !== void 0 && wrappedColumnKeys.includes(cellKey)) && "_1bto1l2s _o5721q9c"])
      }, content);
    }));
  }))));
  return /*#__PURE__*/React.createElement(_flag.FlagsProvider, null, view);
};
var IssueLikeDataTableView = exports.IssueLikeDataTableView = function IssueLikeDataTableView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(IssueLikeDataTableViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_issueLikeTableOld.IssueLikeDataTableViewOld, props);
  }
};
