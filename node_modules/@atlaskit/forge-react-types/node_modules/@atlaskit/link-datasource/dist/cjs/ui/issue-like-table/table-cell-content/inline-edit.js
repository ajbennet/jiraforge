...
var _inlineEditOld = require("./inline-edit-old");
...
var InlineEditNew = function InlineEditNew(_ref) {
  var ari = _ref.ari,
...
var InlineEdit = exports.InlineEdit = function InlineEdit(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(InlineEditNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_inlineEditOld.InlineEditOld, props);
  }
};
