...
exports.PlainConfluenceSearchConfigModalNew = exports.PlainConfluenceSearchConfigModal = exports.ConfluenceSearchConfigModalNew = exports.ConfluenceSearchConfigModal = void 0;
...
var _modalOld = require("./modal-old");
...
var PlainConfluenceSearchConfigModalNew = exports.PlainConfluenceSearchConfigModalNew = function PlainConfluenceSearchConfigModalNew(props) {
  ...
  var _ref = (0, _platformFeatureFlags.fg)('bandicoots-update-sllv-icons') ?
  ...
  var renderTableModalContent = (0, _react.useCallback)(function () {
    if (status === 'rejected') {
      ...
      return /*#__PURE__*/_react.default.createElement(_contentContainer.ContentContainer, null, /*#__PURE__*/_react.default.createElement(_initialStateView.InitialStateView, {
        icon: (0, _platformFeatureFlags.fg)('bandicoots-update-sllv-icons') ? /*#__PURE__*/_react.default.createElement(_search.RichIconSearch, {
          size: "xlarge",
          alt: formatMessage(_messages.confluenceSearchModalMessages.initialViewSearchTitle)
        }) : /*#__PURE__*/_react.default.createElement(_confluenceSearchInitialStateSvgOld.ConfluenceSearchInitialStateSVGOld, null),
  ...
  var renderInlineLinkModalContent = (0, _react.useCallback)(function () {
    if (status === 'unauthorized') {
      ...
      return confluenceSearchUrl && /*#__PURE__*/_react.default.createElement(_countViewSmartLink.SmartLink, {
  ...
  })), currentViewMode === 'inline' ? renderInlineLinkModalContent() : renderTableModalContent()) : /*#__PURE__*/_react.default.createElement(_noInstances.NoInstancesView, {
  ...
  })), /*#__PURE__*/_react.default.createElement(_modalDialog.ModalFooter, null, shouldShowResultsCount && confluenceSearchUrl && /*#__PURE__*/_react.default.createElement(_searchCount.default, {
  ...
  }), !hasNoConfluenceSites && /*#__PURE__*/_react.default.createElement(_insertButton.InsertButton, {
    testId: "confluence-search-datasource-modal--insert-button",
    url: confluenceSearchUrl,
    getAnalyticsPayload: getButtonAnalyticsPayload
  }, /*#__PURE__*/_react.default.createElement(_reactIntlNext.FormattedMessage, _messages.confluenceSearchModalMessages.insertResultsButtonText)))));
};
var PlainConfluenceSearchConfigModal = exports.PlainConfluenceSearchConfigModal = function PlainConfluenceSearchConfigModal(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(PlainConfluenceSearchConfigModalNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_modalOld.PlainConfluenceSearchConfigModalOld, props);
  }
};
...
var ConfluenceSearchConfigModalNew = exports.ConfluenceSearchConfigModalNew = function ConfluenceSearchConfigModalNew(props) {
  return /*#__PURE__*/_react.default.createElement(_state.StoreContainer, null, /*#__PURE__*/_react.default.createElement(ConnectedConfluenceSearchConfigModal, (0, _extends2.default)({}, props, {
    /**
...
var ConfluenceSearchConfigModal = exports.ConfluenceSearchConfigModal = function ConfluenceSearchConfigModal(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(ConfluenceSearchConfigModalNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_modalOld.ConfluenceSearchConfigModalOld, props);
  }
};