...
var _confluenceSearchContainerOld = _interopRequireDefault(require("./confluence-search-container-old"));
...
var ConfluenceSearchContainerExported = function ConfluenceSearchContainerExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(ConfluenceSearchContainer, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_confluenceSearchContainerOld.default, props);
  }
};
var _default = exports.default = ConfluenceSearchContainerExported;