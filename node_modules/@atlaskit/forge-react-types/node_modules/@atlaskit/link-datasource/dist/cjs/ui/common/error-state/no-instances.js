...
exports.NoInstancesViewNew = exports.NoInstancesView = void 0;
...
var _noInstancesOld = require("./no-instances-old");
...
var NoInstancesViewNew = exports.NoInstancesViewNew = function NoInstancesViewNew(_ref) {
...
var NoInstancesView = exports.NoInstancesView = function NoInstancesView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(NoInstancesViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_noInstancesOld.NoInstancesViewOld, props);
  }
};