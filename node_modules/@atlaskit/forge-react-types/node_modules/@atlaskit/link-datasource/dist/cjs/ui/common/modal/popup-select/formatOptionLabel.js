...
var _formatOptionLabelOld = _interopRequireDefault(require("./formatOptionLabelOld"));
var styles = {
...
var formatOptionLabelExported = function formatOptionLabelExported(data) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return formatOptionLabel(data);
  } else {
    return (0, _formatOptionLabelOld.default)(data);
  }
};
var _default = exports.default = formatOptionLabelExported;