...
var _triggerOld = _interopRequireDefault(require("./trigger-old"));
...
var PopupTriggerExported = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(PopupTrigger, (0, _extends2.default)({}, props, {
      ref: ref
    }));
  } else {
    return /*#__PURE__*/_react.default.createElement(_triggerOld.default, (0, _extends2.default)({}, props, {
      ref: ref
    }));
  }
});
var _default = exports.default = PopupTriggerExported;