...
exports.AssetsSearchContainerNew = exports.AssetsSearchContainer = void 0;
...
var _searchContainerOld = require("./search-container-old");
...
var AssetsSearchContainerNew = exports.AssetsSearchContainerNew = function AssetsSearchContainerNew(props) {
...
var AssetsSearchContainer = exports.AssetsSearchContainer = function AssetsSearchContainer(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(AssetsSearchContainerNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_searchContainerOld.AssetsSearchContainerOld, props);
  }
};