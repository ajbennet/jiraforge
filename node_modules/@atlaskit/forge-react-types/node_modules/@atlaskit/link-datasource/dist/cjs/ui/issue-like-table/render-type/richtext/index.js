...
var _richTextOld = _interopRequireDefault(require("./rich-text-old"));
...
var RichTextTypeExported = function RichTextTypeExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(RichTextType, props);
  } else {
    return /*#__PURE__*/React.createElement(_richTextOld.default, props);
  }
};
var _default = exports.default = RichTextTypeExported;