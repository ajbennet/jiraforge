...
var DateRangePicker = exports.DateRangePicker = function DateRangePicker(_ref6) {
  ...
  var popupContent = function popupContent() {
    ...
    return /*#__PURE__*/_react.default.createElement(_styledOld.CustomDropdownOld, null, dateRangeValues.map(function (option) {
      return /*#__PURE__*/_react.default.createElement(_styledOld.CustomDropdownItemOld, {
        key: option
        // want to show Anytime as selected if none of the other options are selected
        ,
        isSelected: selectedValue ? option === selectedValue : option === defaultOptionValue,
    ...
    }), isPickerOpen && isCustomSelected && /*#__PURE__*/_react.default.createElement(_styledOld.CustomDateWrapperOld, null, /*#__PURE__*/_react.default.createElement(_styledOld.DatePickersWrapperOld, null, /*#__PURE__*/_react.default.createElement(_datetimePicker.DatePicker, {
      maxDate: todayDate,
      innerProps: {
        style: {
          width: 140
    ...
    })), invalidDateRange && /*#__PURE__*/_react.default.createElement(_styledOld.DateRangeErrorMessageOld, null, /*#__PURE__*/_react.default.createElement(_error.default, {
      LEGACY_size: "small",
      color: "var(--ds-icon-danger, ".concat(_colors.R400, ")"),
      label: "Date range error",
      LEGACY_margin: "0 ".concat("var(--ds-space-negative-025, -2px)")
    }), invalidDateRange), /*#__PURE__*/_react.default.createElement(_styledOld.SelectDateRangeButtonOld, {
      "data-testId": "custom-date-range-update-button",
      disabled: Boolean(invalidDateRange),
      onClick: handleClickUpdateDateRange
    }, formatMessage(_messages.dateRangeMessages.dateRangeUpdateButton))));
