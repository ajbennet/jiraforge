...
var _datasourceTableViewOld = require("./datasourceTableViewOld");
...
var DatasourceTableViewNew = (0, _analyticsNext.withAnalyticsContext)(_constants.componentMetadata.tableView)(function (props) {
...
var DatasourceTableView = exports.DatasourceTableView = function DatasourceTableView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    ...
    return /*#__PURE__*/React.createElement(_datasourceTableViewOld.DatasourceTableViewOld, props);
  }
};