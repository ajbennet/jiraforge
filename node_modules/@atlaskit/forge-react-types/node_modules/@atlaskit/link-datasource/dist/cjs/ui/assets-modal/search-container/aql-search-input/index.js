...
exports.AqlSearchInputNew = exports.AqlSearchInput = void 0;
...
var _aqlSearchInputOld = require("./aql-search-input-old");
...
var AqlSearchInputNew = exports.AqlSearchInputNew = function AqlSearchInputNew(_ref2) {
...
var AqlSearchInput = exports.AqlSearchInput = function AqlSearchInput(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(AqlSearchInputNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_aqlSearchInputOld.AqlSearchInputOld, props);
  }
};