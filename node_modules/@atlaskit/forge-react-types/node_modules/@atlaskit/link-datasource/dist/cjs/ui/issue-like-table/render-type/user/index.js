...
var _userOld = _interopRequireDefault(require("./user-old"));
...
var UserTypeExported = function UserTypeExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(UserType, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_userOld.default, props);
  }
};
var _default = exports.default = UserTypeExported;