...
exports.default = exports.CustomMenuListExported = void 0;
...
var _menuListOld = _interopRequireDefault(require("./menuListOld"));
...
var CustomMenuList = function CustomMenuList(_ref) {
  ...
  var renderChildren = function renderChildren() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, children, shouldDisplayShowMore && handleShowMore && /*#__PURE__*/_react.default.createElement(_compiled.Box, {
...
var CustomMenuListExported = exports.CustomMenuListExported = function CustomMenuListExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(CustomMenuList, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_menuListOld.default, props);
  }
};
var _default = exports.default = CustomMenuListExported;