...
exports.DisplayViewDropDownNew = exports.DisplayViewDropDown = void 0;
...
var _displayViewDropDownOld = require("./display-view-drop-down-old");
...
var DisplayViewDropDownNew = exports.DisplayViewDropDownNew = function DisplayViewDropDownNew(_ref) {
...
var DisplayViewDropDown = exports.DisplayViewDropDown = function DisplayViewDropDown(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(DisplayViewDropDownNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_displayViewDropDownOld.DisplayViewDropDownOld, props);
  }
};