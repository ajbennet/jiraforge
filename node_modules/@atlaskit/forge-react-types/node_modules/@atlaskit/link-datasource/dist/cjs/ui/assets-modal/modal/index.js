...
exports.AssetsConfigModalNew = exports.AssetsConfigModal = void 0;
...
var AssetsConfigModalNew = exports.AssetsConfigModalNew = (0, _analyticsNext.withAnalyticsContext)(contextData)(function (props) {
...
var AssetsConfigModal = exports.AssetsConfigModal = function AssetsConfigModal(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    ...
    return /*#__PURE__*/React.createElement(_modalOld.AssetsConfigModalOld, props);
  }
};