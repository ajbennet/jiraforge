...
var _modeSwitcherOld = require("./modeSwitcherOld");
...
var ModeSwitcherNew = function ModeSwitcherNew(props) {
  var _options$;
  ...
  return options.length > 0 ? /*#__PURE__*/_react.default.createElement("fieldset", {
    ...
    disabled: isDisabled,
    className: (0, _runtime.ax)(["_2rko1b66 _zulp1b66 _4cvr1h6o _bfhklslw _vchhusvi _1e0c116y _ca0q1b66 _u5f31b66 _n3td1b66 _19bv1b66 _18u0v47k _1j55105o", isCompact && "_zulpv77o _ca0q1b66 _u5f31b66 _n3td1b66 _19bv1b66"]),
    style: {
...
var ModeSwitcher = exports.ModeSwitcher = function ModeSwitcher(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(ModeSwitcherNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_modeSwitcherOld.ModeSwitcherOld, props);
  }
};
