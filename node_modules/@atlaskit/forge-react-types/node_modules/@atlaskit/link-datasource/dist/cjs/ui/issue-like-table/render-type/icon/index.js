...
var _iconOld = _interopRequireDefault(require("./icon-old"));
...
var IconRenderTypeExported = function IconRenderTypeExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(IconRenderType, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_iconOld.default, props);
  }
};
var _default = exports.default = IconRenderTypeExported;