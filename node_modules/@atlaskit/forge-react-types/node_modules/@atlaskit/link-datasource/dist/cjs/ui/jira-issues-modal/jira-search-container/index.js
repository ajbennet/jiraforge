...
exports.JiraSearchContainerNew = exports.JiraSearchContainer = exports.DEFAULT_JQL_QUERY = exports.ALLOWED_ORDER_BY_KEYS = void 0;
...
var _jiraSearchContainerOld = require("./jira-search-container-old");
...
var JiraSearchContainerNew = exports.JiraSearchContainerNew = function JiraSearchContainerNew(props) {
...
var JiraSearchContainer = exports.JiraSearchContainer = function JiraSearchContainer(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(JiraSearchContainerNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_jiraSearchContainerOld.JiraSearchContainerOld, props);
  }
};