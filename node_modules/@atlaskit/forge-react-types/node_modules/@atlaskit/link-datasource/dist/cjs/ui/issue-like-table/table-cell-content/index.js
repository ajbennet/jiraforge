...
var _tableCellContentOld = require("./table-cell-content-old");
var styles = {
...
var TableCellContentNew = function TableCellContentNew(_ref5) {
  var id = _ref5.id,
...
var TableCellContent = exports.TableCellContent = function TableCellContent(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(TableCellContentNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_tableCellContentOld.TableCellContentOld, props);
  }
};