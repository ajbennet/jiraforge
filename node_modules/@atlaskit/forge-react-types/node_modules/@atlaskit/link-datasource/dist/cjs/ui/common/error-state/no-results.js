...
exports.NoResultsNew = exports.NoResults = void 0;
...
var _noResultsOld = require("./no-results-old");
...
var styles = {
  noResultsContainerStyles: "_zulp1ejb _4cvr1h6o _6a6z1h6o _1wpz1h6o _10fp1h6o _19pk1jfw _2hwx1jfw _otyr1jfw _18u01jfw",
  noResultsMessageContainerStyles: "_zulpu2gc _4cvr1h6o _6a6z1h6o"
};
var noop = function noop() {
  return '';
};
var NoResultsNew = exports.NoResultsNew = function NoResultsNew(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_compiled.Grid, {
    ...
    size: "large",
    weight: "bold"
  }, /*#__PURE__*/React.createElement(_reactIntlNext.FormattedMessage, _messages.loadingErrorMessages.noResultsFound)), onRefresh && /*#__PURE__*/React.createElement(_standardButton.default, {
    appearance: "primary",
    onClick: onRefresh
  }, /*#__PURE__*/React.createElement(_reactIntlNext.FormattedMessage, _messages.loadingErrorMessages.refresh))));
};
var NoResults = exports.NoResults = function NoResults(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(NoResultsNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_noResultsOld.NoResultsOld, props);
  }
};