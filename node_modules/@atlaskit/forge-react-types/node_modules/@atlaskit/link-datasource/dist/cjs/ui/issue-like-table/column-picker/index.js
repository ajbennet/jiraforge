...
var _columnPickerOld = require("./column-picker-old");
...
var ColumnPickerNew = function ColumnPickerNew(_ref) {
...
var ColumnPicker = exports.ColumnPicker = function ColumnPicker(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/_react.default.createElement(ColumnPickerNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_columnPickerOld.ColumnPickerOld, props);
  }
};