...
export var DisplayViewDropDownNew = function DisplayViewDropDownNew(_ref) {
...
export var DisplayViewDropDown = function DisplayViewDropDown(props) {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(DisplayViewDropDownNew, props);
  } else {
    return /*#__PURE__*/React.createElement(DisplayViewDropDownOld, props);
  }
};