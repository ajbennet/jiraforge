...
export var DateRangePicker = function DateRangePicker(_ref6) {
  ...
  var popupContent = function popupContent() {
    ...
    return /*#__PURE__*/React.createElement(CustomDropdownOld, null, dateRangeValues.map(function (option) {
      return /*#__PURE__*/React.createElement(CustomDropdownItemOld, {
        key: option
        // want to show Anytime as selected if none of the other options are selected
        ,
        isSelected: selectedValue ? option === selectedValue : option === defaultOptionValue,
    ...
    }), isPickerOpen && isCustomSelected && /*#__PURE__*/React.createElement(CustomDateWrapperOld, null, /*#__PURE__*/React.createElement(DatePickersWrapperOld, null, /*#__PURE__*/React.createElement(DatePicker, {
      maxDate: todayDate,
      innerProps: {
        style: {
          width: 140
