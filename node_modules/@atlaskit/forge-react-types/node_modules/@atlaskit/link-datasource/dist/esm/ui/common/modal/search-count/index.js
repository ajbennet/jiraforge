...
export var AssetsItemCountNew = function AssetsItemCountNew(_ref2) {
...
export var AssetsItemCount = function AssetsItemCount(props) {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(AssetsItemCountNew, props);
  } else {
    return /*#__PURE__*/React.createElement(AssetsItemCountOld, props);
  }
};
...
export var TableSearchCountExported = function TableSearchCountExported(props) {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(TableSearchCount, props);
  } else {
    return /*#__PURE__*/React.createElement(TableSearchCountOld, props);
  }
};
