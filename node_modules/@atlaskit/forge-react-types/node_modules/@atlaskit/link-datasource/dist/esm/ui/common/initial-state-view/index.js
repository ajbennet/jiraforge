...
var betaTagStyles = null;
var searchTitleStyles = null;
var mainTextStyles = null;
var learnMoreLinkStyles = null;
export var InitialStateViewNew = function InitialStateViewNew(_ref) {
  var icon = _ref.icon,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: ax(["_syazg0pi"]),
    style: {
      "--_1dzgjqk": ix("var(--ds-text-subtlest, ".concat(N300, ")"))
    }
  }, formatMessage(description)), learnMoreLink && /*#__PURE__*/React.createElement("a", {
    href: learnMoreLink.href,
    target: "_blank",
    className: ax(["_ca0qpxbi _1e0c1o8l"])
  }, formatMessage(learnMoreLink.text))));
};
export var InitialStateView = function InitialStateView(props) {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(InitialStateViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(InitialStateViewOld, props);
  }
};