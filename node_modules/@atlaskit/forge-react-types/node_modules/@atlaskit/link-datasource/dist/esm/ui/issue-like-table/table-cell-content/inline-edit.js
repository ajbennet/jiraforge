...
export var InlineEdit = function InlineEdit(props) {
  if (fg('bandicoots-compiled-migration-link-datasource')) {
    return /*#__PURE__*/React.createElement(InlineEditNew, props);
  } else {
    return /*#__PURE__*/React.createElement(InlineEditOld, props);
  }
};
