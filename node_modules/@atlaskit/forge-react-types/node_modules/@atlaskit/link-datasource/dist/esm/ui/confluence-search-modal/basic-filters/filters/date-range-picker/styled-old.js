...
export var PopupComponentContainerOld = styled.div({
...
// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled, @atlaskit/ui-styling-standard/no-exported-styles -- Ignored via go/DSP-18766
export var CustomDropdownOld = styled.div({
  width: '340px',
  background: "var(--ds-background-input, ".concat(N0, ")"),
  borderRadius: "var(--ds-border-radius-100, 4px)",
  boxShadow: "var(--ds-shadow-overlay, 0px 0px 1px 0px rgba(9, 30, 66, 0.31), 0px 3px 5px 0px rgba(9, 30, 66, 0.20))",
...
export var CustomDropdownItemOld = styled.div(function (props) {
  return {
    height: '36px',
    width: '100%',
    display: 'flex',
...
// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled, @atlaskit/ui-styling-standard/no-exported-styles -- Ignored via go/DSP-18766
export var CustomDateWrapperOld = styled.div({
  padding: "var(--ds-space-150, 12px)",
  boxSizing: 'border-box'
});

// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled, @atlaskit/ui-styling-standard/no-exported-styles -- Ignored via go/DSP-18766
export var DatePickersWrapperOld = styled.div({
  display: 'flex',
...
// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled, @atlaskit/ui-styling-standard/no-exported-styles -- Ignored via go/DSP-18766
export var SelectDateRangeButtonOld = styled.button({
...
// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled, @atlaskit/ui-styling-standard/no-exported-styles -- Ignored via go/DSP-18766
export var DateRangeErrorMessageOld = styled.div({
  display: 'flex',
