...
var shouldRedactValue = exports.shouldRedactValue = function shouldRedactValue(value) {
  return isString(value) && startsAsObject(value) || isObject(value);
};
var redactValue = exports.redactValue = function redactValue(featureFlagValue) {
