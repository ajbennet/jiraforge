...
var generateSpanId = exports.generateSpanId = function generateSpanId() {
  return Array.from(new Array(16), function () {
    return Math.floor(Math.random() * 16).toString(16);
  }).join('');
};
var setInteractionActiveTrace = exports.setInteractionActiveTrace = function setInteractionActiveTrace(interactionId, experienceType) {
  setActiveTrace(interactionId.replace(/-/g, ''), generateSpanId(), experienceType);
};
var setActiveTrace = exports.setActiveTrace = function setActiveTrace(traceId, spanId, type) {
  state.context = {
    traceId: traceId,
    spanId: spanId,
    type: type
...
var getActiveTrace = exports.getActiveTrace = function getActiveTrace() {
  return state.context || undefined;
};
var clearActiveTrace = exports.clearActiveTrace = function clearActiveTrace() {
  state.context = null;
};
var getActiveTraceHttpRequestHeaders = exports.getActiveTraceHttpRequestHeaders = function getActiveTraceHttpRequestHeaders(_url) {
