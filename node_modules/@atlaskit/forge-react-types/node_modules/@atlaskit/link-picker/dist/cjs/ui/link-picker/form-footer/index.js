...
exports.testIds = exports.messages = exports.FormFooterNew = exports.FormFooter = void 0;
...
var FormFooterNew = exports.FormFooterNew = /*#__PURE__*/(0, _react.memo)(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement("footer", (0, _extends2.default)({
    className: (0, _runtime.ax)(["_1e0c1txw _1bahesu3", className])
  }, restProps), isSubmitting && /*#__PURE__*/React.createElement(_visuallyHidden.default, {
    role: "status",
    id: submitMessageId,
  ...
  }, createButton(action)), /*#__PURE__*/React.createElement(_button.ButtonGroup, null, onCancel && /*#__PURE__*/React.createElement(_button.default, {
    appearance: "subtle",
    onClick: onCancel,
    testId: testIds.cancelButton,
    isDisabled: isSubmitting,
    "aria-labelledby": isSubmitting ? submitMessageId : undefined
  }, intl.formatMessage(messages.cancelButton)), !hideSubmitButton && /*#__PURE__*/React.createElement(_linkPickerSubmitButton.LinkPickerSubmitButton, {
    isEditing: isEditing,
    isLoading: isLoading,
...
var FormFooter = exports.FormFooter = function FormFooter(props) {
  ...
  return /*#__PURE__*/React.createElement(_old.FormFooterOld, props);
};