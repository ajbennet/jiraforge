...
exports.testIds = exports.SearchResultsNew = exports.SearchResults = void 0;
...
var SearchResultsNew = exports.SearchResultsNew = function SearchResultsNew(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_searchResultsContainer.SearchResultsContainer, {
    ...
    className: (0, _runtime.ax)(["_1tkeys9h _1e0c1txw _4cvr1h6o _1bah1h6o _1wpz1h6o _16jlkb7n"])
  }, /*#__PURE__*/React.createElement(_spinner.default, {
    testId: testIds.tabsLoadingIndicator,
    interactionName: "link-picker-tabs-loading",
    size: "medium"
  })), !isLoadingPlugins && isActivePlugin && !!queryState && /*#__PURE__*/React.createElement(_react.Fragment, null, tabs.length > 0 && /*#__PURE__*/React.createElement(_compiled.Box, {
...
var SearchResults = exports.SearchResults = function SearchResults(props) {
  ...
  return /*#__PURE__*/React.createElement(_old.SearchResultsOld, props);
};