...
export var TextWrapperOldVisualRefresh = forwardRef(function (_ref5, __cmplr) {
  ...
  var isPlaceholder = __cmplp.isPlaceholder,
    __cmpldp = _objectWithoutProperties(__cmplp, _excluded10);
  return /*#__PURE__*/React.createElement(C, _extends({}, __cmpldp, {
    style: __cmpls,
    ref: __cmplr,
...
export var TooltipWrapperOldVisualRefresh = forwardRef(function (_ref6, __cmplr) {
  var _ref6$as = _ref6.as,
    ...
    __cmpls = _ref6.style,
    __cmplp = _objectWithoutProperties(_ref6, _excluded11);
...
export var ContentOldVisualRefresh = forwardRef(function (_ref7, __cmplr) {
  var _ref7$as = _ref7.as,
    ...
    __cmpls = _ref7.style,
    __cmplp = _objectWithoutProperties(_ref7, _excluded12);
  var removeOverflow = __cmplp.removeOverflow,
    allowScrollBar = __cmplp.allowScrollBar,
    frameStyle = __cmplp.frameStyle,
    __cmpldp = _objectWithoutProperties(__cmplp, _excluded13);
  return /*#__PURE__*/React.createElement(C, _extends({}, __cmpldp, {
    style: __cmpls,
    ref: __cmplr,
...
// eslint-disable-next-line @atlaskit/ui-styling-standard/no-styled,@atlaskit/ui-styling-standard/no-exported-styles
export var Image = forwardRef(function (_ref8, __cmplr) {
  var _ref8$as = _ref8.as,
    C = _ref8$as === void 0 ? "img" : _ref8$as,
    __cmpls = _ref8.style,
    __cmplp = _objectWithoutProperties(_ref8, _excluded14);
  return /*#__PURE__*/React.createElement(C, _extends({}, __cmplp, {
    style: _objectSpread(_objectSpread({}, __cmpls), {}, {
...
export var Thumbnail = forwardRef(function (_ref9, __cmplr) {
  var _ref9$as = _ref9.as,
    C = _ref9$as === void 0 ? "div" : _ref9$as,
    __cmpls = _ref9.style,
    __cmplp = _objectWithoutProperties(_ref9, _excluded15);
  return /*#__PURE__*/React.createElement(C, _extends({}, __cmplp, {
    style: _objectSpread(_objectSpread({}, __cmpls), {}, {
