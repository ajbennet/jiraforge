...
const HoverCardLoadingViewNew = ({
  ...
  const actionGroup = (actions === null || actions === void 0 ? void 0 : actions.length) && (actions === null || actions === void 0 ? void 0 : actions.length) > 0 && /*#__PURE__*/React.createElement(ActionGroup, {
    items: actions,
    visibleButtonsNum: 2
  });
...
const HoverCardLoadingView = props => {
  if (fg('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(HoverCardLoadingViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(HoverCardLoadingViewOld, props);
  }
};
