...
// TODO: Remove on fg cleanup: platform-linking-visual-refresh-v1
const horizontalStyleByHeightOld = {
...
const ElementGroup = props => {
  if (fg('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(ElementGroupNew, props);
  } else {
    return /*#__PURE__*/React.createElement(ElementGroupOld, props);
  }
};
