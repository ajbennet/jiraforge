...
const AutomationActionNew = props => {
...
const AutomationAction = props => {
  if (fg('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(AutomationActionNew, props);
  }
  return /*#__PURE__*/React.createElement(AutomationActionOld, props);
};
