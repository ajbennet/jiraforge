...
var _ResolvedViewOld = _interopRequireDefault(require("./ResolvedViewOld"));
...
var ResolvedViewExported = function ResolvedViewExported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    ...
    return /*#__PURE__*/React.createElement(_ResolvedViewOld.default, props);
  }
};
var _default = exports.default = (0, _withFlexibleUIBlockCardStyle.withFlexibleUIBlockCardStyle)(ResolvedViewExported);