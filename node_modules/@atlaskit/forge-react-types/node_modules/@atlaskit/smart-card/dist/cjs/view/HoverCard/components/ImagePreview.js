...
var _ImagePreviewOld = _interopRequireDefault(require("./ImagePreviewOld"));
...
var ImagePreviewNew = function ImagePreviewNew(_ref) {
  var data = _ref.data,
...
var ImagePreview = function ImagePreview(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    ...
    return (0, _ImagePreviewOld.default)(props);
  }
};
