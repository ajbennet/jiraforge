...
require("./ContentContainer.compiled.css");
...
var _ContentContainerOld = _interopRequireDefault(require("./ContentContainerOld"));
...
var ConnectedAIPrismContainer = function ConnectedAIPrismContainer(_ref) {
  ...
  var _useState = (0, _react.useState)(status === 'loading'),
...
var Exported = function Exported(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(ContentContainer, props);
  } else {
    return /*#__PURE__*/React.createElement(_ContentContainerOld.default, props);
  }
};
