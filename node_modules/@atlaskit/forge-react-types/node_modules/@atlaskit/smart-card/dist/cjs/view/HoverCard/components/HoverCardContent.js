...
var _HoverCardContentOld = _interopRequireDefault(require("./HoverCardContentOld"));
...
var HoverCardContentNew = function HoverCardContentNew(_ref) {
...
var HoverCardContent = function HoverCardContent(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/_react.default.createElement(HoverCardContentNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_HoverCardContentOld.default, props);
  }
};
