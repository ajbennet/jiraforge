...
var TitleBlockResolvingView = function TitleBlockResolvingView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(TitleBlockResolvingViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_TitleBlockResolvingViewOld.default, props);
  }
};
var _default = exports.default = TitleBlockResolvingView;