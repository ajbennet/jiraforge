...
var _AISummaryOld = _interopRequireDefault(require("./AISummaryOld"));
 ...
 */
var AISummaryNew = function AISummaryNew(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_markdownToJsx.default, {
    ...
    ,
    className: (0, _runtime.ax)([!(0, _platformFeatureFlags.fg)('platform-linking-visual-refresh-v1') && "_11c8qk37 _slp31hna _1nmz1hna _o5724jg8 _181u1kdv _1rkw1kdv _te171kdv _uizt1kdv", (0, _platformFeatureFlags.fg)('platform-linking-visual-refresh-v1') && "_11c81vlj _syaz1gjq _slp31hna _1nmz1hna _o5724jg8 _181u1kdv _1rkw1kdv _te171kdv _uizt1kdv", className]),
    children: content,
    options: {
      forceWrapper: true,
      overrides: {
...
var AISummary = function AISummary(props) {
  ...
  return /*#__PURE__*/React.createElement(_AISummaryOld.default, props);
};
