...
var TitleBlockErroredView = function TitleBlockErroredView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/_react.default.createElement(TitleBlockErroredViewNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_TitleBlockErroredViewOld.default, props);
  }
};
var _default = exports.default = TitleBlockErroredView;