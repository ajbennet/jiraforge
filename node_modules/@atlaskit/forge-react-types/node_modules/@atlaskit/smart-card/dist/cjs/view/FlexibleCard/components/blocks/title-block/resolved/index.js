...
var TitleBlockResolvedView = function TitleBlockResolvedView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/React.createElement(TitleBlockResolvedViewNew, props);
  } else {
    return /*#__PURE__*/React.createElement(_TitleBlockResolvedViewOld.default, props);
  }
};
var _default = exports.default = TitleBlockResolvedView;