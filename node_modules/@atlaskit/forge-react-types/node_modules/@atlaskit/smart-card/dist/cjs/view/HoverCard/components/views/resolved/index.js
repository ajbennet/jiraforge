...
var _HoverCardResolvedViewOld = _interopRequireDefault(require("./HoverCardResolvedViewOld"));
...
var HoverCardResolvedView = function HoverCardResolvedView(props) {
  if ((0, _platformFeatureFlags.fg)('bandicoots-compiled-migration-smartcard')) {
    return /*#__PURE__*/_react.default.createElement(HoverCardResolvedViewNew, props);
  } else {
    return /*#__PURE__*/_react.default.createElement(_HoverCardResolvedViewOld.default, props);
  }
};
