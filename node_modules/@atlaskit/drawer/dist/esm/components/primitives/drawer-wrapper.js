...
var wrapperStyles = css(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
  display: 'flex',
  height: '100vh',
  position: 'fixed',
  zIndex: 500,
  backgroundColor: "var(--ds-surface-overlay, ".concat(N0, ")")
}, CURRENT_SURFACE_CSS_VAR, "var(--ds-surface-overlay, ".concat(N0, ")")), "insetBlockStart", 0), "insetInlineStart", 0), "overflow", 'hidden'));
/**
